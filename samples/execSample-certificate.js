...
var options = { host:credentials.TESTHost(), username:credentials.TESTUser(), certificate:credentials.TESTCertificateFile(),password:credentials.TESTPass(), port:credentials.TESTPort() };
